...
if ( is_user_logged_in() ) {
    $sql = "SELECT title, url, descr, rtype, src FROM rtable WHERE rtypecode=3";
} else {
    $sql = "SELECT title, url, descr, rtype, src FROM rtable WHERE rtypecode=3 AND public=1";
}
                        ...
                        <?php endwhile; // end of the loop. ?>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="http://localhost:8888/wordpress/resources/">All</a>
                            ...
                            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="col-md-4 col-xs-4">Resource Category</th>
                                        <th class="col-md-2 col-xs-2">Source System</th>
                                    </tr>
